...
features = cPickle.load(open('nn_features30.p', 'rb'))
val_features = cPickle.load(open('nn_val_features30.p', 'rb'))
test_features = cPickle.load(open('nn_test_features30.p', 'rb'))
labels = cPickle.load(open('labels30.p', 'rb'))
